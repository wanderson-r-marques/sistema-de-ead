...
// funções para redimensionamento
	...
	*/
	private function calculaPosicaoCrop()
	{
		...
		//se imagem em pé corta do top pra baixo
		global $funcaoPosicao;
...
// gera imagem de saída
	 ...
	 * @return void
	*/	
	public function grava( $destino='', $qualidade ) 
	{
