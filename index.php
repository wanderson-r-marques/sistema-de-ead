				...
				<div class="row justify-content-center">
					<div class="col-lg-5 col-md-6 col-sm-12">
						<div class="sec-heading center">
							<p>Cursos</p>
							<h2><span class="theme-cl">Educação</span> em alta</h2>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-1">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">Educação inclusiva</a></h4>
								<ul class="meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-4">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">Educação especial - AEE</a></h4>
								<ul class="meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-10">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">Educação híbrida</a></h4>
								<ul class="meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-6">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">Alfabetização e letramento</a></h4>
								<ul class="meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-7">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">TEA, TGD, Proposta de intervenção educacional</a></h4>
								<ul class="meta">
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-8">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">Musicalização infantil</a></h4>
								<ul class="meta">
									<li class="video"><i class="ti-video-clapper"></i>43 Classes</li>
								</ul>
							</div>
					...
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="edu_cat_2 cat-9">
							...
							<div class="edu_cat_data">
								<h4 class="title"><a href="#">Educação infantil em tempo integral</a></h4>
								<ul class="meta">
