...
if ($_POST['token'] == '43534gfgfg7f6g-*uyddhgjg') {
  ...
  $query = "INSERT INTO AC_MATERIAL_PARA_ALUNOS (
    ...
    QTD_HORAS
	   ...
	   VALUES ('$mensagem','$cod_disciplina','$cod_turma','2021','$cod_professor','$link','$material',now(),'$qtd_horas'  )";
...
<head>
  ...
  <script src="https://use.fontawesome.com/81ccae7975.js"></script>
          ...
          <form class="text-left" action="dados.php" method="post" enctype="multipart/form-data">
            ...
            <div class="alert alert-secondary" role="alert">
              <div class="btn-group" style="float:right">
                <a href="atidades_respondidas.php"  class="btn btn-primary">Atividades Respondidas Alunos</a>
                <a href="frequencia_aluno.php" class="btn btn-primary">Freq. Aluno na plataforma</a>
                <a href="atividades_entregues.php" class="btn btn-primary">Conteudo Vistado pelo Aluno </a>
                <a href="logout.php" class="btn btn-danger">Sair</a>
              </div>
              <h4><b>Suas turmas de 2021</b></h4>
 ...
 ";
              ...
              <select name="disciplina" required readonly class="form-control" id="disciplina">
                ...
                foreach ($rows as $key => $value) {
                  echo "<option value='" . $value->AC_CADASTRO_DISCIPLINA . "#" . $value->AC_CADASTRO_TURMA . "'>" . $value->TURMA . ' - ' . $value->DESCRICAO . ' - ' . $value->NOME_TURMA . "</option>";
                }
                ?>
              </select>
            </div>
      ...
      <div id="tab-material" class="table-responsive">
        ...
        <table class="table table-bordered table-hover table-sm table-striped">
          ...
          <tbody>
            ...
            $query = " 
              ...
              JOIN AC_CADASTRO_CURSOS             F ON E.AC_CADASTRO_TURMA = F.AC_CADASTRO_CURSO
            ...
            ORDER BY E.AC_MATERIAL_PARA_ALUNOS DESC
            ...
            ?>
              ...
              <tr>
                ...
                <td class="text-center"><a href="<?= $value->LINK ?>" target="_blank"><i class="fa fa-search"></i>Visualizar  </a></td>
                <td class="text-center"><a href="funcoesMaterial.php?pk=<?= $value->AC_MATERIAL_PARA_ALUNOS ?>&funcao=deletar" target="_blank" class="text-danger"><i class="fa fa-trash"></i>Deletar  </a></td>
