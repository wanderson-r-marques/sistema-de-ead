    ...
    <div class="container">
      <div class="row ">
        <div class="col-12">
          ...
          <p class="mb-3 lead teste text-center"><br>Eventos Marcado como Vistos pelos Alunos
          </p>
          <p class="mb-4 text-center">Seja bem vindo(a) Professor(a): <b><?= $nome_professor; ?></b> </p>
          <form class="text-left " action="atividades_entregues.php#tabela" method="post" enctype="multipart/form-data">
        ...
        <table id="example" class="table  table-striped sampleTable table-bordered table-borderless table-hover table-sm" style="width:100%">
          ...
          <tbody>
            ...
            $AC_CADASTRO_TURMA = $disciplina[1] ?? $value->AC_CADASTRO_TURMA;
                 ...
                 LEFT JOIN AC_REALIZADO_ALUNOS_ARQUIVOS H ON A.AC_MATERIAL_PARA_ALUNOS= H.AC_MATERIAL_PARA_ALUNOS
                                                         AND A.ENTIDADE = H.ENTIDADE
                        ...
                        ORDER BY A.AC_MATERIAL_PARA_ALUNOS DESC , C.NOME";
