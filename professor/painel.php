			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-12">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="../template/#">Painel</a></li>
									</ol>
								</nav>
							</div>
						</div>
						...
						<div class="row">
							<?php
							$query = "SELECT g.`MATERIAL_TAREFA` qtd_tarefas
								FROM entidades a JOIN alunos_escolas_turmas b ON a.`PK_ENTIDADE` = b.`PK_ENTIDADE`
								 JOIN turmas c ON b.`PK_TURMA` = c.`PK_TURMA` 
								 JOIN series d ON c.`PK_SERIE` = d.`PK_SERIES` 
								 JOIN curriculo e ON d.`PK_SERIES` = e.serie 
								 JOIN alunos_material f ON c.`PK_TURMA` = f.`PK_TURMA` 
								 AND e.disciplina = f.`PK_DISCIPLINA` 
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="dashboard_stats_wrap widget-1">
									<div class="dashboard_stats_wrap_content">
										<h4><?= $smtp->rowCount(); ?></h4> <span>Materiais</span>
									</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="dashboard_stats_wrap widget-2">
									<div class="dashboard_stats_wrap_content">
										<h4><?= $smtp->rowCount(); ?></h4> <span>Professores</span>
									</div>
							...
							<div class="col-lg-4 col-md-6 col-sm-12">
								<div class="dashboard_stats_wrap widget-4">
									<div class="dashboard_stats_wrap_content">
										<h4><?= $smtp->rowCount(); ?></h4> <span>Alunos</span>
									</div>
