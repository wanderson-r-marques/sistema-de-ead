                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    $where = " AND a.data_hora_resposta IS NOT NULL AND d.`PK_ENTIDADE` = $pk_entidade";

                                                                    $query = "SELECT  MAX(j.DESCRICAO) AS serie,
                                                                    MAX(i.DESCRICAO) AS turma, 
                                                                    MAX(k.`DESCRICAO`) AS turno ,
                                                                    i.`PK_TURMA`
                                                                    ...
                                                                    JOIN turmas i ON e.`PK_TURMA` = i.`PK_TURMA` 
                                                                    JOIN escolas f ON i.PK_ESCOLA = f.`PK_ESCOLA` 
                                                                    JOIN series j ON i.`PK_SERIE` = j.`PK_SERIES` 
                                                                    JOIN turnos k ON i.`PK_TURNO` = k.`PK_TURNO` 
                                                                    WHERE a.data_hora_resposta IS NOT NULL 
                                                                    AND f.`PK_ESCOLA` = ?
																	$where																	
																	GROUP BY i.`PK_TURMA`";
                                                                    ...
                                                                    if ($smtp->execute([$pk_escola])) {
																		...
																		LIMIT $inicio,$maximo";
                                                                        $smtp = $con->prepare($query);
                                                                        $smtp->execute([$pk_escola]);

                                                                        $linhas = $smtp->fetchAll(PDO::FETCH_OBJ);
                                                                        foreach ($linhas as $linha) {
                                                                    ?>
                                                                            <tr>
                                                                                <th scope="row"><?= $linha->serie ?></th>
                                                                                <th scope="row"><?= $linha->turma ?></th>
                                                                                <th scope="row"><?= $linha->turno ?></th>
