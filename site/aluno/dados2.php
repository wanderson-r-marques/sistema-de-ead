    ...
    <div class="container">
      <div class="row">
        <div class="bg-white p-5 mx-auto col-md-12 col-12">
          ...
          <p class="mb-3 lead teste"><br>Dados do Aluno para verificação<object data="" type=""></object></p>
          <div class="row">
            <div class="col-md-12">
              <?= $alerta; ?>
              <div class="card text-left">
                <div class="card-header text-uppercase bg-success text-white"> <b> SEJA BEM VINDO ! </b>
                  <span style="float: right"><a href="logout2.php" style="color:#fff; text-decoration: none; font-weight: bold">Sair</a> </span> </div>
                <div class="card-body">
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              <?php if ($value->AC_CADASTRO_TIPO_MATERIAL == 4) { ?>
                                ...
                                <?php if (1 == 1) : // Verifica se já foi enviada a atividade?>
                                ...
                                <?php else : ?>
                                  <button type="button" class="btn btn-success" data-target="#exampleModal">
                                    Enviado
                                  </button>
                                <?php endif; ?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!-- Corpo do Modal -->
            <form method="post" wm-formFile enctype="multipart/form-data">
          ...
          fetch(url, {
            ...
            .then(function(text) {
              if (text == 'true') {
                ...
                btnResponder.removeAttribute('wm-responder')
                btnResponder.removeAttribute('data-toggle')
