...
var YoutubeDialog = {
    ...
    insert: function () {
      ...
      // tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<img src="http://img.youtube.com/vi/' + code + '/0.jpg" class="mceItem" alt="' + code + '"/>');
		 tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<iframe width="560" height="315" src="//www.youtube.com/embed/'+ code +'?rel=0" frameborder="0" allowfullscreen></iframe>');
        tinyMCEPopup.close();
    }
};
