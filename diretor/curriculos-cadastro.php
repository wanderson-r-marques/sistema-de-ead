            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                        <form action="curriculos-funcao.php?funcao=cadastrar" method="post">
                            <!-- Row -->
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Currículo Cadastro
                                            </li>
                                        </ol>
                                    </nav>
                                </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <select name="serie" required class="form-control">
                                                            ...
                                                            <option value="<?= $linha->PK ?>"><?= $linha->DESCRICAO ?>
                                                            </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input type="text" name="curriculo" required
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        <h3>Disciplinas</h3>
                                                        <?php
                                                        $query = "SELECT `PK_DISCIPLINAS`, DESCRICAO FROM disciplinas ORDER BY DESCRICAO";
                                                        $smtp = $con->prepare($query);
                                                        $smtp->execute();
                                                        $linhas = $smtp->fetchAll(PDO::FETCH_OBJ);
                                                        ...
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="disciplinas[]" class="ml-3"
                                                                id="inlineCheckbox1"
