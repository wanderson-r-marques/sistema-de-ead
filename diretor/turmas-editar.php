								...
								<div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Turmas Editar</li>
										</ol>
									</nav>
								</div>
							</div>
											...
											<div class="submit-section">
												<div class="form-row">
													...
													<label>Escola</label>
														...
														?>														
														<select name="escola" required wm-estado class="form-control">
													...
													<div class="form-group col-md-6">
														...
														<?php 
															...
															$linhas = $smtp->fetchAll(PDO::FETCH_OBJ);
														?>														
														<select name="serie" required wm-estado class="form-control">
														<?php foreach($linhas as $linha): ?>
													...
													<div class="form-group col-md-6">
														<label>Turma</label>
														<input type="text"  value="<?= $linhaDB->DESCRICAO ?>" name="turma" required class="form-control col-md-12">
													</div>
													<div class="form-group col-md-6">
														<label>Turno</label>
														<?php 
															...
															$linhas = $smtp->fetchAll(PDO::FETCH_OBJ);
														?>														
														<select name="turno" required wm-estado class="form-control">
														<?php foreach($linhas as $linha): ?>
