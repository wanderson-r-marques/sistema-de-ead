                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Adicionar professores
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                                    ...
                                    <div class="dashboard_container_body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <div class="cart_totals checkout">
                                                                ...
                                                                <div class="cart-wrap">
                                                                    <ul class="cart_list" id="reports_in"
										...
										JOIN entidades e ON a.`entidade` = e.`PK_ENTIDADE`
										 WHERE a.`escola` = ?";
                                                                    ...
                                                                    <button type="button" onclick="setAlunosParaTurma()"
                                                                        class="btn checkout_btn">Atualizar
                                                                        turma</button>
                                                        ...
                                                        function drop_in(ev) {
                                                            ...
                                                            document.getElementById("reports_in").appendChild(document
                                                                .getElementById(data))
                                                        }
                                                        ...
                                                        function drop_out(ev) {
                                                            ev.preventDefault();
                                                            var data = ev.dataTransfer.getData("text")
                                                            document.getElementById("reports_out").appendChild(document
                                                                .getElementById(data))
                                                        }
