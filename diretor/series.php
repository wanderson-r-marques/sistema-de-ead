											...
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="dashboard_container">
													<div class="form-group col-md-12" style="margin-top:1rem;">
														<a href="series-cadastro.php" class="btn add-items"><i class="fa fa-plus-circle"></i>Adicionar série</a>
													</div>
													<div class="dashboard_container_body">
																			...
																			<tr>
																				...
																				<td>
																					<div class="dash_action_link">
																						<a href="series-editar.php?pk=<?= $linha->PK_SERIES ?>" class="view">Editar</a>
																						<a onclick="return confirm('Deseja deletar?')" href="series-funcao.php?funcao=deletar&pk=<?= $linha->PK_SERIES ?>" class="cancel">Deletar</a>
																					</div>
																				</td>
																			</tr>
																	<?php
