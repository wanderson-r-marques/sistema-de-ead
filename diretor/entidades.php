                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="dashboard_container">
                                                    <div class="form-group col-md-12" style="margin-top:1rem;">
                                                        <a href="entidades-cadastro.php" class="btn add-items"><i
                                                                class="fa fa-plus-circle"></i>Adicionar entidades</a>
                                                        <a href="entidades-importar.php" class="btn add-items"><i
                                                                class="fa fa-upload"></i>Importar entidades</a>
                                                    </div>
                                                    <div class="dashboard_container_body">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
																	...
																	?>
                                                                    <tr>
                                                                        <th scope="row" wm-lista><?= $linha->TIPO ?>
                                                                        </th>
                                                                        <td><?= $linha->NOME ?></td>
                                                                        <td><?= $linha->TELEFONE1 ?></td>
                                                                        <td>
                                                                            <div class="dash_action_link">
                                                                                <a href="entidades-editar.php?pk=<?= $linha->PK_ENTIDADE ?>"
                                                                                    class="view">Editar</a>
                                                                                <a onclick="return confirm('Deseja deletar?')"
                                                                                    href="entidades-funcao.php?funcao=deletar&pk=<?= $linha->PK_ENTIDADE ?>"
                                                                                    class="cancel">Deletar</a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                    <?php
