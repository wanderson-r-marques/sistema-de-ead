    ...
    <div class="dashboard-navbar">
        ...
        <div class="d-user-avater">
            ...
            <div class="linkFoto">
                ...
                <form action="helpers/upload-imagem.php" method="post" name="dateForm" enctype="multipart/form-data">
                    <img src="<?php echo (file_exists('../' . $foto)) ? '../' . $foto : '../assets/fotos/user.png' ?>"
                        class="img-fluid avater" alt="Perfil">
                    <div class="input-group mb-3 alterarFoto">

                        <div class="custom-file">

                            <input type="file" name="foto" onchange="document.forms['dateForm'].submit();"
        ...
        <div class="d-navigation">
            <ul id="side-menu">
                ...
                <li class="<?= pgActive('series') ?>">
                    <a href="series.php"><i class="ti-blackboard"></i>Séries</a>
                </li>
