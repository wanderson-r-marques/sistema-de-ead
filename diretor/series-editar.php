...
if (isset($_GET['pk']) &&  is_numeric($_GET['pk'])) {
	$pk = $_GET['pk'];
	$query = "SELECT DESCRICAO FROM series WHERE PK_SERIES = :pk";
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-9 col-md-9 col-sm-12">
						<form action="series-funcao.php?funcao=editar&pk=<?= $pk ?>" method="post">
							<!-- Row -->
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Série Editar</li>
										</ol>
									</nav>
								</div>
							</div>
