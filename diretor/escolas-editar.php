			...
			<section class="gray pt-0">
				<div class="container-fluid">
					...
					<?php include_once 'include/nav.php'?>
						...
						<form action="escolas-funcao.php?funcao=editar&pk=<?= $pk ?>" method="post">
							<!-- Row -->
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
									<nav aria-label="breadcrumb">
										<ol class="breadcrumb">
											...
											<li class="breadcrumb-item active" aria-current="page">Escolas Editar</li>
										</ol>
									</nav>
								</div>
							</div>
											...
											<div class="submit-section">
												<div class="form-row">
													<div class="form-group col-md-6">
														<label>Escola</label>
														<input type="text" value="<?= $linha->DESCRICAO ?? '' ?>" name="escola" required class="form-control">
													</div>
													...
													<div class="form-group col-md-12">
														<label>CEP</label>
														<input type="text" value="<?= $linha->CEP ?? '' ?>" name="cep" wm-cep required class="form-control col-md-5 cep">
													</div>
													<div class="form-group col-md-6">
														<label>Logradouro</label>
														<input type="text" value="<?= $linha->LOGRADOURO ?? '' ?>" name="logradouro" required wm-logradouro class="form-control">
													</div>
													<div class="form-group col-md-6">
														<label>Número</label>
													...
													<div class="form-group col-md-6">
														...
														<input type="text" value="<?= $linha->COMPLEMENTO ?? '' ?>" name="complemento"  class="form-control">
													</div>
													<div class="form-group col-md-6">
														<label>Bairro</label>
														<input type="text" name="bairro" value="<?= $linha->BAIRRO ?? '' ?>" required wm-bairro class="form-control">
													</div>
													<div class="form-group col-md-6">
														<label>Cidade</label>
														<input type="text" name="cidade" value="<?= $linha->CIDADE ?? '' ?>" required wm-cidade class="form-control">
													</div>
													<div class="form-group col-md-6">
														<label>Estado</label>
														<select name="estado" required wm-estado class="form-control">
