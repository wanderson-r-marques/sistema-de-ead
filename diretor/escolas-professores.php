							...
							<div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb">
										...
										<li class="breadcrumb-item" aria-current="page">Escolas</li>
														...
														<div class="table-responsive">
															<table class="table">
																...
																<tbody>
																	...
																	$where = '';
																	$busca = $_GET['p'] ?? '';
																	$where = " WHERE e.`DESCRICAO` LIKE ('%" . $busca . "%') || en.`NOME` LIKE ('%" . $busca . "%')";

																	$query = "SELECT pe.professor_escola pk, e.DESCRICAO escola, en.NOME professor FROM professor_escola pe
																	JOIN escolas e ON pe.escola = e.PK_ESCOLA
																	JOIN entidades en ON pe.entidade = en.PK_ENTIDADE
$where
ORDER BY e.DESCRICAO, en.NOME";
